...
function Baner() {
    return (
        <>
            <div class="mt-44 pt-10-2 bg-gradient-to-r from-cyan-500 to-blue-500y">
                <div class="container w-full flex items-center mx-auto  text-white py-32 px-16 " >
                    <div class="w-1/2">
            ...
            <div class="container mx-auto pb-32 pt-32">
